pipeline {
   ...
   stages {
      ...
      stage('push'){
           ...
           steps {
                 sh '''
                       docker rmi -f esp51springboot
                       docker rmi -f es51-app
                       ...
                       docker tag esp51springboot 192.168.160.99:5000/es51-app
           ...
           steps {
                ...
                sshagent (credentials: ['esp51v2']) {
                   sh '''
                        ...
                        ssh -o StrictHostKeyChecking=no esp51@192.168.160.103 docker run -d -it -p 51880:80 --name Esp51Frontend 192.168.160.99:5000/es51-app
                   '''
